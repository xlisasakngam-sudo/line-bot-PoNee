...
const TG_GROUP_URL = 'https://telegram.me/UFApro99\nhttps://telegram.me/UFAPro99_V2';
...
const ENDED_PROMO_WORDS = [
  'เคลมบิล','โปรเคลมบิล','สลิปแลกเครดิต','แลกเครดิต','เคลมสลิป',
  'ฝากต่อเนื่อง','ฝากประจำ','ฝากสะสม','สะสมวัน','ครบ 3 วัน','ครบ 7 วัน','ครบ 15 วัน','ครบ 30 วัน',
  'โปรฝาก','ฝากรับโบนัส',
];
function isEndedPromo(text) {
  return ENDED_PROMO_WORDS.some(function(w) { return text.toLowerCase().includes(w); });
}
...
async function aiChat(userMsg, history) {
  ...
  var lines = [
    ...
    'กลุ่ม TG รับโค้ดโปร: https://shorturl.asia/HJzrw | ซอลญ่า คือ LINE @757xinte',
    '',
    ...
    '',
    '### โปรเคลมบิล/สลิปแลกเครดิต/ฝากต่อเนื่อง/ฝากสะสม',
    'โปรเหล่านี้สิ้นสุดกิจกรรมแล้ว ถ้าลูกค้าถามให้ตอบว่าหมดแล้วและแนะนำกลุ่ม TG',
    '',
    '### โปรฝากประจำ/ฝากต่อเนื่อง (สิ้นสุดแล้ว)',
    'โปรนี้สิ้นสุดกิจกรรมแล้ว ถ้าลูกค้าถามให้ตอบว่าหมดแล้วและแนะนำกลุ่ม TG',
    '',
    '### รับแต้มเพชรฟรี/กงล้อ',
    'ยอดฝาก 300 ได้รับ 30 แต้ม สะสมเครดิตได้สูงสุด 10,000 เครดิต แต้มใช้แลกของรางวัลที่ร้านค้าแลกเหรียญหรือหมุนกงล้อได้ ทำเทิร์น 10 เท่า ถอนได้ 1 เท่า เล่นได้แค่สล็อต ห้ามซื้อฟรีสปิน ผิดกฎงดถอน ไปที่เมนูอื่นๆ→รับแต้มเพชรฟรี | ไปที่เมนูอื่นๆ→ร้านค้าแลกเหรียญ',
    '',
    '### โปรวันเกิด',
    ...
    '',
    '### เช็คอิน',
    'ฝากบิล 100 รับฟรี 50 ทำยอด 500 เท่า ถอนได้ 50 บาท กด "ฝากเงินเพื่อรับรางวัล" ก่อนทำรายการฝาก เล่นได้แค่สล็อต ห้ามซื้อฟรีสปิน ผิดกฎงดถอน ไปที่เมนูอื่นๆ→เช็คอิน',
    '',
    '### แรงค์กิ้ง (Ranking)',
    ...
    'ต้องมีฝากและยอดเล่นสะสมครบตามแรงค์ เพื่อเลื่อนยศและรับของรางวัล สะสมได้ตลอดชีพ ไม่มีตัดสิทธิ์',
    'เล่นได้แค่สล็อต ห้ามซื้อฟรีสปิน ผิดกฎงดถอน ไปที่เมนูอื่นๆ→อันดับ',
    '',
    '### ทายผลเลขท้าย',
    ...
    '',
    '### โปรที่ยังมีอยู่ (ต้องกดรับก่อนฝากเท่านั้น)',
    '',
    '### โปรสมาชิกใหม่',
    ...
    'ถ้าลูกค้าถามหาเว็บ/ลิงก์เว็บ/เว็บคืออะไร → ส่งลิงก์ https://shorturl.asia/Uz5mH ได้เลย',
...
async function handleEvent(event) {
  ...
  if (isCashbackQ) {
    var lossMsg = '📝เงื่อนไขคืนยอดเสียหน้าเว็บ📝\nสล็อตคืนยอดเสีย 𝟏𝟎%\n-ทำยอด 𝟖 เท่า ถอนได้ 𝟏 เท่า-\n(เล่นได้แค่สล็อต ห้ามซื้อฟรีสปิน ผิดกฎงดถอน)\n\nคาสิโน+ยิงปลา คืนยอดเสีย 𝟓%\n-ทำยอด 𝟖 เท่า ถอนได้ 𝟏 เท่า\n-ต้องมียอดเดิมพันอย่างน้อย 𝟓 ไม้ ห้าม 𝐀𝐋𝐋 𝐈𝐍\n\nกดรับยอดเสียได้ทุกวันก่อนเวลา 𝟐𝟑.𝟑𝟎น.นะคะ\n\nไปที่เมนูอื่นๆ→รับยอดเสีย';
  ...
  // ====== โปรสิ้นสุดแล้ว ======
  if (isEndedPromo(msgText)) {
    var endedMsg = '🙇🏻\u200d\u2640\ufe0fขออภัยค่ะโปรโมชั่นนี้สิ้นสุดกิจกรรมแล้ว\nรับโค้ดฝากอื่นๆได้ที่กลุ่มเทเลแกรมนะคะ\n\n' + TG_GROUP_URL;
    await lineReply(replyToken, txt(endedMsg));
    await addHistory(userId, 'bot', endedMsg.substring(0, 80));
    return;
  }
  ...
  // ====== ตามยอดฝาก → ขอข้อมูลแล้วส่ง TG ======
  if (isFollowUp(msgText)) {
    var exFollow = extractContact(msgText);
    if (exFollow.phone || exFollow.bank) {
      var followSum = [
        exFollow.phone ? 'เบอร์: ' + exFollow.phone : null,
        exFollow.bank  ? 'บัญชี: ' + exFollow.bank  : null,
        'ข้อความ: ' + msgText,
      ].filter(Boolean).join('\n');
      await tgSlipAlert(displayName, '[ตามยอดฝาก] ' + followSum);
      await markHandled(userId);
      var followDone = 'รับเรื่องแล้วค่ะ กำลังดำเนินการให้นะคะ รอสักครู่ค่ะ \u23F0';
      await lineReply(replyToken, txt(followDone));
      await addHistory(userId, 'bot', followDone);
    } else {
      var followAsk = 'ขอเบอร์โทรหรือเลขบัญชีธนาคารด้วยนะคะ เพื่อตรวจสอบยอดให้ค่ะ \u{1F4CB}';
      await setSlipState(userId, { step: 'waiting_info', ts: Date.now() });
      await lineReply(replyToken, txt(followAsk));
      await addHistory(userId, 'bot', followAsk);
    }
    return;
  }
  ...
  if (aiReply.includes('##ESCALATE##') || aiReply.toUpperCase().includes('ESCALATE')) {
    ...
    if (m.includes('ทรูมันนี่') || m.includes('truemoney') || m.includes('ทูมันนี่') || m.includes('วอลเลท') || m.includes('wallet') || m.includes('พร้อมเพย์') || m.includes('promptpay')) {
      ...
      await lineReply(replyToken, txt('สมัครได้เลยนะคะ 📝\n' + REGISTER_URL));
